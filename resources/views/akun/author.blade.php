        ...
        <div class="row mx-2">
            <div class="col-8">
                <div class="profil-saya-left">
                    <div class="container">
                        @if ($author->gambar)
                            <img src="{{ secure_asset('storage/' . $author->gambar) }}" alt="" class="img-fluid">
                        @else
                            <img src="{{ secure_asset('images/flynn.png') }}" alt="" class="img-fluid">
                        @endif
                        ...
                        @else
                            <div class="ukb-card">
                                <a href="/berita/{{ $beritas2->slug }}" style="text-decoration: none; color:black;">
                                    @if ($beritas2->gambar)
                                        <img src="{{ $beritas2->gambar ? secure_asset('storage/' . $beritas2->gambar) : 'https://source.unsplash.com/1417x745?' }}" style="object-fit: cover; width: 100%; height: 150px; max-width: 400px;" class="w-100 rounded-4 text-center" alt="...">
                                    @else
